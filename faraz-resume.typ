...
Full-stack software engineer with 5 years building production web and mobile systems, from idea to owned infrastructure. Co-founded and led engineering at Parhako, an edtech platform of three shipped products serving 2,200+ registered users and 60+ paying customers. Stack: TypeScript, React, Next.js, Node.js, Express, GraphQL, AWS, Supabase.
...
#bullets(
  [Co-founded Parhako and led a team of 3 engineers across three production apps (parhako.com, Parhako NET, Parhako MDCAT) now serving 2,200+ registered users with 60+ paying customers, built with Next.js + TypeScript and Node.js on AWS.],
...
#heading("Projects")
  ...
  github.com/faraz-35/application-filler
][
  Personal
][
  2026
...
#bullets(
  [A minimal macOS to-do list where completed items become a timestamped journal automatically. Per-task timers, reminders, and a command palette. Tauri (Rust) + React + SQLite.],
)

#entry[
  Writing Partner
][
  github.com/faraz-35/writing
][
  Personal
][
  2026
...
#bullets(
  [Singable English subtitles for YouTube songs: rewrites the lyrics to fit the music instead of a stiff literal translation, shown as a browser overlay. Python (FastAPI, yt-dlp, GLM) + Firefox extension.],
)
...
AWS Cloud Solutions Architect, DevOps on AWS (AWS); IBM Full Stack Software Developer (IBM); Meta Front-End Developer, Meta React Native (Meta).
